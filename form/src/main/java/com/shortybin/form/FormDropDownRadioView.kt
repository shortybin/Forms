...
import kotlinx.android.synthetic.main.form_droop_down_radio_view.view.*

class FormDropDownRadioView @JvmOverloads constructor(
    context: Context, attrs: AttributeSet? = null
) : FormView(context, attrs) {
    override fun layoutId(): Int {
        return R.layout.form_droop_down_radio_view
    }
